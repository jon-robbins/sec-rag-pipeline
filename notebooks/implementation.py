...
if os.path.exists(embeddings_dir / "target_150_overlap_50_ceiling_500.pkl"):
    with open(embeddings_dir / "target_150_overlap_50_ceiling_500.pkl", "rb") as f:
        ...
        print(
            f"✅ Loaded {len(chunks)} chunks from {embeddings_dir / 'target_150_overlap_50_ceiling_500.pkl'}"
        )
else:
...
from sec_insights.evaluation.generate_qa_dataset import prepare_chunks_for_qa_generation
